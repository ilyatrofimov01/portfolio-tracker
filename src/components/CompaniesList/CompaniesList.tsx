...
export function CompaniesList({selectedCompany, companies, onCompanyClick, sortDirection}: CompaniesListProps): JSX.Element {
    ...
    const sortedCompanies = companies.sort(((company, company2) => {
        if (sortDirection === "desc" ) {
            return company2.currentPrice - company.currentPrice;
        }

        return company.currentPrice - company2.currentPrice;
    }));
